const C='brigada-adm-offline-v8';
const A=['./','./index.html','./manifest.webmanifest','./icon.svg','./areas1.js','./areas2.js','./areas3.js','./areas4.js','./scenarios.js','./quick.js','./map1.txt','./map2.txt','./map3.txt','./map4.txt'];
